...
**Version:** MVP — Bazaar Theme Variant  
...
- Palette selector (5 options: Newcomer, Regular, Local, Insider, Legend)

**Bazaar brand:** Logo = cat hawker behind quầy hàng. Brand name = **Stallspot**. Tagline = **"Open a stall. Trade memes."**
...
### G.4. Top Banner 
- **Bazaar marquee:** "OPEN A STALL · TRADE MEMES · WATCH THE CROWD · NO RIGGED SCALES · BIGGEST CROWD WINS · TIPS WHISPERED HERE"
- Color rules: "OPEN A STALL", "WATCH THE CROWD", "TIPS WHISPERED HERE" → amber (`#EAB552`); "BIGGEST CROWD WINS" → teal (`#7cc4a4`); others → gray
...
| Graduated | **Graduated** | ✅ Standard term |
...
### 2.6. Stall Story (Bazaar NEW component)

Khi đã có token description, hiển thị dưới dạng callout giữa chart card và trades table:
...
- Border-left amber, italic body text, amber label
- Source field: `token.description` (existing field from FR-007)
- Creator label format: **"stall by alice · Local tier · 12d ago"** (replaces plain "by alice")
...
**Bazaar wizard welcome headline:** "Open your stall" (themed framing — user has context buffer at start of creation flow). Step labels and field labels inside wizard remain standard (Token name, Symbol, Description, Settings, etc.).

**Final CTA:** "Launch token" (crypto convention standard). |
...
### 8.1. Tabs — **3 tabs**
- **Lucky Vendor Draw** (mặc định) — ⚠️ Bazaar rename of "Slot Machine"
- **Lucky Wheel** ➕
- **Club Rewards** ➕
...
### 8.3. Lucky Vendor Draw Tab (Bazaar rename of "Slot Machine")

**Bazaar microcopy changes:**
- Feature name: **Lucky Vendor Draw** (replaces "Slot Machine" / "Slot Rewards")
- Spin CTA: **"Roll the dice"** (or "Spin" if shorter fits UI)
- Win message: **"The bazaar smiles on you — X!"** (replaces "You won X!")
- Lose message: **"The crowd's distracted — try again"** (replaces "Try again")

**Mechanics: UNCHANGED.** Probability, payout, rotation logic identical.

| Feature | MVP | Status |
|---|---|---|
| SLOT REWARD (SOL) | ✅ 0.000 SOL + CLAIM button | |
| YOUR TICKETS count | ✅ 0 + Roll the dice button | Bazaar CTA |
| 5 reels slot machine | ✅ 5 reels | |
| Multipliers table | ✅ 7 symbols (x1, x1.5, x2, x3, x5, x10, x25) | |
| Rules display | ✅ How to play + Winning + How to collect SOL | |
| History table | ✅ Columns: Time, Bet, Result, Payout | |
| Convert Points section | ✅ Current points display | |
...
**Bazaar microcopy (gamification layer):**
- Headline: **"Bring a friend to the bazaar"**
- Body: **"Earn 5% commission when they trade at your stall"**
- Referral code label: **"Your stall card"**
...
- Total Referrals: 0 ✅
- Total Volume: 0 SOL ✅
- Unclaimed Rewards: 0 SOL ✅
- CLAIM REWARD button ✅

### 9.2. Referral Link Section
- "How it works?" + description ✅
- Your stall card link + GENERATE LINK button ✅

### 9.3. Referred Users Table
- Columns: DATE JOINED, WALLET, TRADING VOLUME, YOUR REWARDS ✅
- Empty state: "Share your stall card to start earning" ✅
...
- **Rank card:** Tier 1 · Newcomer — Progress bar + Next Tier: 500 pts ✅
- "500 points away from Tier 2 · Regular" + "0 / 500 pts in this tier" ✅
- **CTA:** "Roll the dice for Rewards" → "Go to Rewards" button ✅
- **Point History:** Columns: DATE, TYPE, POINTS ✅
- Empty state: "You'll see your point history here" + "Nothing yet? Switch wallets or trade to earn points at the bazaar." ✅
...
| Feature FRD | MVP | Status |
|---|---|---|
| Rank display (5 tiers) | ✅ Tier 1 Newcomer hiển thị | Bazaar tier |
| Progress bar | ✅ | |
...
## BAZAAR THEME SUMMARY

> Theme-specific naming — core trading UI (Buy/Sell, Volume, Market Cap, Trust Score, Chart) UNCHANGED between Sprout and Bazaar.

| Concept | Bazaar Value |
|---|---|
| Brand name | Stallspot |
| Subtitle | the meme bazaar |
| Tagline | Open a stall. Trade memes. |
| Mascot | Cat hawker behind quầy hàng |
| Tier 1 (0 pts) | Newcomer |
| Tier 2 (500) | Regular |
| Tier 3 (2K) | Local |
| Tier 4 (10K) | Insider |
| Tier 5 (50K) | Legend |
| Slot Rewards | Lucky Vendor Draw |
| Token War event | Bazaar Showdown |
| Referral copy | Bring a friend to the bazaar |
| Referral code | Your stall card |
| Create token CTA | Create token (standard) |
| Wizard welcome | Open your stall |
| Status badge new | New |
| Status badge graduating | Almost graduated |
| Graduation banner | GRADUATED · NOW ON RAYDIUM + cat money-eyes |
| 404 page | This stall doesn't exist. Maybe it never opened — or maybe it franchised away. |
| Empty token list | No stalls match. Try a different filter. |
| Onboarding welcome | Welcome to the bazaar — where memes get traded. |
