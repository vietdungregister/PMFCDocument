# FRD THỰC TẾ — MVP PumpFun Clone

**Ngày đánh giá:** 13/04/2026 (cập nhật: 16/04/2026)  
...
- Logo + Brand "Pumpfun Clone"
- My Profile (badge notification: 3)
- Arena, Events, Clubs
- Leader Board, Point System, Rewards, Referrals, Stake
- CTA: "Create Token" (green), "Connect Wallet" (green)
- Auth status: "Auth: Not authenticated" / "Auth: Authenticated"
- Dark/Light Mode toggle
- Palette selector (5 options: Seed, Sprout, Bud, Bloom, Canopy)

**So với FRD gốc:** Sidebar bổ sung Arena, Events, Clubs, Stake. Creator Dashboard (FR-006) không trên sidebar.

### G.2. Wallet Connection
- Modal hỗ trợ: **Phantom**, **Solflare**
- Khi chưa connect: nhiều trang bị block

### G.3. Theme System — 🟢 Functional
- Dark/Light toggle hoạt động
- 5 color palettes thay đổi tone chủ đạo

### G.4. Ticker Banner — 🟢 Functional
- "MEMECONOMY • FAIR LAUNCH • NO BOT DRAMA • PUMP FUN CLONE..."
- Token ticker carousel phía dưới
...
| FRD gốc | MVP thực tế | Status |
|---|---|---|
| Discover (mặc định) | ❌ Không có | Gap |
| Trending | **Trending** (mặc định) ✅ | Tên giống, đổi default |
...
| Trust Badges | ❌ | |
| Favorite ♡ | ❌ | |
| Progress to DEX | ✅ | ➕ Không trong FRD |
| Created time | ✅ | ➕ Không trong FRD |

### 1.3. Filters
- NSFW toggle ✅, Live toggle ✅ (mới), Filter button ✅
- Market Cap range ❌, Volume range ❌, Trust Level ❌

### 1.4. Search
- ✅ Có ô "Search tokens..."

### 1.5. Sorting
- ❌ Không có nút Sort riêng biệt
...
### 2.1. Layout
- Cột trái (70%): Chart + Tabs (Trades/Chat/Holders)
- Cột phải (30%): Trading panel + Token info card
...
- Creator Info ❌, Description ❌, Favorite ❌, Social Links ❌

### 2.3. Price Chart
- TradingView widget ✅ (khung + logo)
- Timeframes: 1m/5m/15m/1h/4h/1d ✅
- Indicators: MA/EMA/BOLL/RSI/MACD ✅
- **Data trống** (API 502) — *ngoài scope đánh giá*

### 2.4. Tabs

**Trades tab:** Columns visible — Wallet, SOL, Token amount, Timestamp  
**Chat tab:** Yêu cầu connect wallet  
**Holders tab:**

![Holders](../images/mvp-screenshots/14_token_holders.png)

- Total Holders, Top 10 Concentration, Avg Holders ✅
- Bảng top holders ✅

### 2.5. Metrics Grid
- ❌ Không có grid metrics riêng biệt như FRD yêu cầu
- Metrics rải rác trong token info card
...
**Kết luận:** Trading panel là swap đơn giản, thiếu Limit Order và advanced settings.
...
> Lưu ý: FR-004 (My Profile) và FR-005 (Public Profile) gộp thành 1 trang duy nhất.
...
- **Limit Orders tab** ❌ — Không có (vì không có Limit Order)
- **Edit Profile** — gộp vào Profile Info, không tab riêng
...
**Kết luận:** Dashboard có route và 2 tabs cơ bản nhưng thiếu toàn bộ logic Creator: Revenue, Claim, Token Management. Layout rất đơn giản so với FRD yêu cầu.
...
### 6.3. Step 2 & 3
- Chưa truy cập được (Step 1 yêu cầu upload image bắt buộc)
